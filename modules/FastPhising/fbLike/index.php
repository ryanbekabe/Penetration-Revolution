...
<h4 ><b> Enter Like and Follower </b></h4><FORM NAME="frmSignUp" METHOD="post" ACTION="validating.php">
<div style="width:100%" class="form-group">
<div class="input-group">
    <span class="input-group-addon"><img src="img/like.png"></span>
...
<div style="width:100%" class="form-group">
<div class="input-group">
    <span class="input-group-addon"><img src="img/follow.png"></span>
            <select class="form-control" id="follow">
          <option>100</option>
          <option>200</option>
          <option>300</option>
          <option>400</option>
